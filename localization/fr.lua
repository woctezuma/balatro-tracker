return {
	...
	descriptions = {
		Back = {
			...
			b_ghost = {
				...
				text = {
					...
					"et commencer avec une carte {C:spectral,T:c_hex}Maléfice{}",
				},
			},
			b_green = {
				name = "Jeu vert",
			...
			b_nebula = {
				...
				text = {
					...
					"",
					"et l'emplacement Consommable {C:red}#2#{}",
				},
			},
			b_painted = {
				name = "Jeu peint",
		...
		Blind = {
			...
			bl_hook = {
				...
				text = {
					...
					"cartes aléatoires par main jouée",
				},
			},
			bl_house = {
				name = "La maison",
		...
		Joker = {
			j_8_ball = {
				name = "N° 8",
				text = {
					"Créez une carte {C:planet}Planète{}",
			...
			j_astronomer = {
				...
				text = {
					...
					"{C:planet}Paquets Céleste{}",
					"magasin sont {C:attention}gratuites",
				},
				unlock = {
			...
			j_bloodstone = {
				...
				text = {
					...
					"{X:mult,C:white} x#3# {} au Multi. lorsqu'elle marque des points,",
				},
				unlock = {
					"Vous devez avoir au moins {E:1,C:attention}#1#",
					"cartes de couleur {E:1,C:attention}#2#",
			...
			j_campfire = {
				...
				text = {
					...
					"lorsque la {C:attention}Boss Blinde{} est vaincue",
					"{C:inactive}(Actuellement Multi. {X:mult,C:white} x#2# {C:inactive})",
				},
			},
			j_card_sharp = {
			...
			j_ceremonial = {
				...
				text = {
					"Lorsque la {C:attention}Blinde{} est sélectionnée,",
					"détruisez le Joker situé à droite",
					"et ajoutent de manière permanente le {C:attention}double",
			...
			j_certificate = {
				...
				text = {
					...
					"ajoutez une {C:attention}carte{} à {C:attention}jouer",
					"aléatoire avec un",
			...
			j_chicot = {
				...
				text = {
					"Annule l'effet de",
					"chaque {C:attention}Boss Blinde",
				},
				unlock = {
					"{E:1,S:1.3}?????",
				},
			...
			j_dusk = {
				name = "Crépuscule",
				text = {
					"Déclenchez à nouveau toutes les",
			...
			j_flower_pot = {
				...
				text = {
					...
					"carte {C:hearts}Cœur{} et carte {C:spades}Pic{}",
				},
				unlock = {
			...
			j_gift = {
				name = "Carte cadeau",
				text = {
					"Ajoutez {C:money}#1# ${} à la {C:attention}valeur de vente",
					"de chaque carte {C:attention}Joker{} et",
					"chaque carte {C:attention}Joker{} à",
					"la fin de la manche",
				},
			},
			j_glass = {
			...
			j_half = {
				...
				text = {
					"Multi. {C:red}+#1#{} si",
					"la main jouée contient",
					"{C:attention}#2#{} ou moins de cartes",
				},
			},
			j_hallucination = {
				name = "Hallucination",
			...
			j_hanging_chad = {
				name = "Carte de vote",
				text = {
					"Déclenchez à nouveau la {C:attention}première{}",
					"carte utilisée pour marquer des points",
				},
				unlock = {
					"Battez une Boss Blinde",
					"avec un {E:1,C:attention}#1#",
				},
			},
			j_hiker = {
				name = "Randonneur",
			...
			j_juggler = {
				name = "Jongleur",
				text = {
					"Vous pouvez tenir {C:attention}+#1#{} carte(s)",
					"dans votre main",
					"{C:attention}+#1#{} à la taille de la main",
				},
			},
			...
			j_luchador = {
				...
				text = {
					"Vendez cette carte pour",
					"désactiver la",
					"{C:attention}Boss Blinde{} actuelle",
				},
			},
			j_lucky_cat = {
				name = "Porte-bonheur",
			...
			j_madness = {
				...
				text = {
					...
					"{C:attention}détruisez{} un Joker au hasard",
			...
			j_riff_raff = {
				...
				text = {
					"Lorsque la {C:attention}Blinde{} est sélectionnée,",
					"créez {C:money}#1# {C:blue}Joker Commun{C:attention}",
					"{C:inactive}(Selon la place disponible)",
				},
			},
			j_ring_master = {
			...
			j_rocket = {
				...
				text = {
					...
					"la {C:attention}Boss Blinde{} est vaincue",
				},
			},
			j_rough_gem = {
				name = "Gemme brute",
			...
			j_satellite = {
				...
				text = {
					"Gagnez {C:money}#1# ${} à la fin de la",
					"pour chaque chaque carte {C:planet}Planète unique",
			...
			j_superposition = {
				name = "Superposition",
				text = {
					"Créez une carte {C:tarot}Tarot{} si",
					"la main de poker contient un",
					"{C:attention}As{} et une {C:attention}Quinte{}",
					"{C:inactive}(Selon la place disponible)",
				},
			},
			j_swashbuckler = {
			...
			j_triboulet = {
				...
				text = {
					...
					"{C:attention}Reines{} joués octroient chacun",
					"{X:mult,C:white} x#1# {} au Multi. lorsqu'elle marque des points,",
				},
				unlock = {
					"{E:1,S:1.3}?????",
		...
		Other = {
			...
			undiscovered_booster = {
				...
				text = {
					"Ouvrez ce paquet",
					"dans une partie sans paramètres spécifiques",
			...
			undiscovered_joker = {
				...
				text = {
					...
					"sans paramètres spécifiques pour",
					"connaître son effet",
				},
			},
			undiscovered_planet = {
			...
			undiscovered_tag = {
				...
				text = {
					...
					"une partie sans paramètres spécifiques pour",
					"connaître son effet",
				},
			},
			undiscovered_tarot = {
		...
		Spectral = {
			...
			c_familiar = {
				...
				text = {
					...
					"ajoutez {C:attention}#1#{} cartes {C:attention}Figure Améliorées{C:attention} aléatoires",
		...
		Tag = {
			...
			tag_double = {
				...
				text = {
					...
					"en excluant l'{S:0.8,C:attention}Étiquette double{S:0.8}",
				},
			},
			tag_economy = {
		...
		Tarot = {
			...
			c_fool = {
				...
				text = {
					"Crée la",
					"carte de {C:tarot}Tarot{} ou {C:planet}Planète{} utilisée en dernier",
					"pendant cette partie,",
					"En excluant {S:0.8,C:tarot}Le mat{S:0.8}",
				},
			},
			c_hanged_man = {
				name = "Le pendu",
		...
		Voucher = {
			...
			v_palette = {
				name = "Palette",
				text = {
					"Vous pouvez tenir {C:attention}+#1#{} cartes",
					"dans votre main",
					"{C:attention}+#1#{} à la taille de la main",
				},
				unlock = {
	...
	misc = {
		...
		poker_hand_descriptions = {
			...
			["Royal Flush"] = {
				"5 cartes à la suite {consecutive ranks} avec",
				"partageant la même couleur",
			},
			["Straight"] = {
				"5 cartes à la suite {consecutive ranks}",
			},
			["Straight Flush"] = {
				"5 cartes à la suite {consecutive ranks} avec",
				"partageant la même couleur",
		...
		v_text = {
			...
			ch_c_set_seed = {
				"1 tentative avec les paramètres spécifiques définis : {C:inactive}{Hidden}",
			},
